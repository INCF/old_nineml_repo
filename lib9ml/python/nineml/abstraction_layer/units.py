...
mass_per_charge = Dimension(name="charge", m=1, i=-1, t=-1)
charge = Dimension(name="charge", i=1, t=1)
mass_per_length2 = Dimension(name="mass_per_length2", l=-2, n=1)
chargeDensity = Dimension(name="chargeDensity", i=1, t=1, l=-3)
charge_per_mole = Dimension(name="charge_per_mole", i=1, t=1, n=-1)
current = Dimension(name="current", i=1)
current_per_time = Dimension(name="current_per_time", i=1, t=-1)
...
kMolDims = Dimension(name="kMolDims", m=1, l=2, t=-2, k=-1)
rho_factor = Dimension(name="rho_factor", l=-1, n=1, i=-1, t=-1)
flux = Dimension(name="flux", m=1, l=-3, t=-1)
per_time_concentration = Dimension(name="per_time_concentration", l=3, t=-1, n=1)
dimensionless = None
...
J_per_K = Unit(name="J_per_K", dimension=kMolDims, power=0)
