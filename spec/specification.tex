...
\newcommand{\PruneToTarget}{\defRef{\textbf{\class{PruneToTarget}}\xspace}{sec:PruneToTarget}}
...
% Define Composition Layer element references
...
\newcommand{\DerivedParameter}{\defRef{\textbf{\class{DerivedParameter}}\xspace}{sec:DerivedParameter}}
...
% Define Parameterization Layer element references

\newcommand{\ComponentProperties}{\defRef{\textbf{\class{ComponentProperties}}\xspace}{sec:ComponentProperties}}
...
\newcommand{\NetworkProperties}{\defRef{\textbf{\class{NetworkProperties}}\xspace}{sec:NetworkProperties}}
\newcommand{\PopulationProperties}{\defRef{\textbf{\class{PopulationProperties}}\xspace}{sec:PopulationProperties}}
\newcommand{\ProjectionProperties}{\defRef{\textbf{\class{ProjectionProperties}}\xspace}{sec:ProjectionProperties}}
...
\newcommand{\MultiComponentProperties}{\defRef{\textbf{\class{MultiComponentProperties}}\xspace}{sec:MultiComponentProperties}}
...
\newcommand{\MultiCompartmentalProperties}{\defRef{\textbf{\class{MultiCompartmentalProperties}}\xspace}{sec:MultiCompartmentalProperties}}
\newcommand{\MultiCompartmentalProjection}{\defRef{\textbf{\class{MultiCompartmentalProjection}}\xspace}{sec:MultiCompartmentalProjection}}
\newcommand{\MultiCompartmentalProjectionProperties}{\defRef{\textbf{\class{MultiCompartmentalProjectionProperties}}\xspace}{sec:MultiCompartmentalProjectionProperties}}
...
\subsection{PruneToTarget}
\label{sec:PruneToTarget}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{PruneToTarget Structure}}}\\
    \toprule
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
...
\subsection{DerivedParameter}
\label{sec:DerivedParameter}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{DerivedParameter Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \identifier & yes\\
    ...
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \MathInline | \FromComponent & singleton & yes \\
    \bottomrule
  \end{edtable}
\end{table}
...
The array of values represented by a \FromComponent element is populated from the output port of a component. As of version 1.0, only components are supported within \FromComponent but function and generator components are planned for later versions. The size of the generated array is determined by the size of the container (i.e. \Population or \Projection) the \FromComponent is nested within.
...
The number of cells in the population is specified by the integer provided to a builtin property of the \Population called \textit{number}. If this number is derived from other parameters it can be provided by a \DerivedParameter. 
...
\clearpage
\part{Parameterization Layer}

\section{Parameterization of Components}

\subsection{ComponentProperties}
\label{sec:ComponentProperties}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{ComponentProperties Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
...
\section{Parameterization of Containers}

\subsection{NetworkProperties}
\label{sec:NetworkProperties}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{NetworkProperties Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    ...
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Reference | \Prototype & singleton & yes \\ 
    \Property & set & no\\
    \PopulationProperties & set & yes \\
    \ProjectionProperties & set & yes \\
    \bottomrule
  \end{edtable}
\end{table}

\subsection{PopulationProperties}
\label{sec:PopulationProperties}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{PopulationProperties Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \Population{}@name & yes\\
    \midrule
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Reference | \Prototype & singleton & yes \\ 
    \Property & set & no\\
     \ComponentProperties | \MultiComponentProperties | \MultiCompartmentalProperties & set & yes \\
    \bottomrule
  \end{edtable}
\end{table}

\subsection{ProjectionProperties}
\label{sec:ProjectionProperties}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{ProjectionProperties Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \Projection{}@name & yes\\
    \midrule
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Reference | \Prototype & singleton & yes \\ 
    \Property & set & no\\
    \ComponentProperties | \MultiComponentProperties & set & yes \\    
    \bottomrule
  \end{edtable}
\end{table}
...
\subsection{MultiComponentProperties}
\label{sec:MultiComponentProperties}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{MultiComponentProperties Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \MultiComponent{}@name & yes\\
    \midrule
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Reference | \Prototype & singleton & yes \\ 
...
\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{MultiCompartmentalProjection Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \identifier & yes\\
...
An extension of the \Projection object model, \MultiCompartmentalProjection, must be used if either the source or destination populations consist of multi-compartmental models. It receives a \CompartmentConnectivity element which determines which compartments projections are made. 

In flattening the \MultiCompartmentalProjection elements to Core NineML, a single \MultiCompartmentalProjection is split into a set of \Projection elements, one for each source/destination compartment pairing that has a non-empty set of connections.

\subsubsection{Name attribute}
Each \MultiCompartmentalProjection requires a \textit{name} attribute, which should be a valid \identifier and uniquely identify the \MultiCompartmentalProjection in the global scope.
...
The \CompartmentConnectivity element specifies the connections between source and destination compartments if the \Connectivity element of the \MultiCompartmentalProjection specifies a connection between the source and destination cell models. 

\subsection{MultiCompartmentalProperties}
\label{sec:MultiCompartmentalProperties}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{MultiCompartmentalProperties Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \MultiCompartmental{}@name & yes\\
    \midrule
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Reference | \Prototype & singleton & yes \\ 
...
\subsection{MultiCompartmentalProjectionProperties}
\label{sec:MultiCompartmentalProjectionProperties}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{MultiCompartmentalProjectionProperties Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \MultiCompartmentalProjection{}@name & yes\\
    \midrule
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Reference | \Prototype & singleton & yes \\ 
